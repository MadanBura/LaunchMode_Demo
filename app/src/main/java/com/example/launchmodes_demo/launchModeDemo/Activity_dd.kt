...
import com.example.launchmodes_demo.databinding.ActivityDdBinding

class Activity_dd : AppCompatActivity() {

    private lateinit var binding : ActivityDdBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDdBinding.inflate(layoutInflater)
